...
import { categories, guides } from "../shared/data/guides";
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const timeout = window.setTimeout(() => setSavedIds(saved), 0);
  ...
  const savedGuides = guides.filter((guide) => savedIds.includes(guide.id));
  const selectedGuide =
